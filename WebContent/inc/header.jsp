	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#563d7c;">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link" href="<%=conPath%>/notice/list.jsp">Notice</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<%=conPath%>/emp/list.jsp">Emp</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<%=conPath%>/dept/list.jsp">Dept</a>
				</li>
				<li class="nav-item">
